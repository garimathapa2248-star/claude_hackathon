...
function askSug(el) {
  ...
  setTimeout(() => {
    removeTyping();
    addMessage(answers[q] || "That's a great question about your specific situation. Based on your NJIT documents, I'd recommend reaching out to financialaid@njit.edu directly about this â€” they can give you the most accurate answer for your specific package.", 'bot');
  }, 1400);
}
...
function sendMsg() {
  ...
  setTimeout(() => {
    ...
    let reply = "Based on your NJIT financial aid documents, I can see this relates to your overall package. For the most accurate guidance specific to your situation, I'd recommend also checking with NJIT's financial aid office at financialaid@njit.edu â€” but here's what I can tell you from your documents: your biggest financial risk right now is the variable rate private loan, followed by the scholarship GPA requirement. Would you like me to explain either of those in more detail?";
